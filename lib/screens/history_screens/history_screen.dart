...
class _HistoryScreenState extends State<HistoryScreen> {
              ...
              child: ListView.builder(
                ...
                itemBuilder: (contextECGRecords, index) {
                  ...
                  final String recordName =
                      allECGRecordsPreview[index]["data_directory"].split("/").last.split('.').first;
  ...
  Widget buildHistoryCard(int recordId, String inputText, String date) {
    return InkWell(
      onTap: () {
        Navigator.push(context, MaterialPageRoute(builder: (context) => HistoryRecordChart(recordId: recordId)));
      },
      child: Container(
        ...
        child: Row(
          children: [
            Container(
              ...
              child: const Center(child: Icon(Icons.favorite_border, color: Color.fromARGB(255, 57, 5, 243), size: 30)),
            ),
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  Text('$inputText $recordId', style: const TextStyle(fontSize: 14)),
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Text('$recordId BPM', style: const TextStyle(color: Colors.white, fontSize: 12)),
                ],
              ),
            ),
          ],
