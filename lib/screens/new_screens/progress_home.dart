        ...
        Stack(
          children: [
            ...
            Container(
              height: 16,
              width: 100 * value,
              decoration: BoxDecoration(color: progressColor, borderRadius: BorderRadius.circular(8)),
            ),
          ],
        ),
        const SizedBox(height: 8),
        Text(valueReal, style: const TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
      ],
    );
  }
}
