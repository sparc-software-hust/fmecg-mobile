...
class EcgPacketParser {
  ...
  static double convertThreeBytesToSignedDecimal(List<int> threeChannelBytes) {
    ...
    int unsignedDecimalValue =
        threeChannelBytes[0] * math.pow(2, 16).toInt() +
  ...
  static List<double> convertDecimalValuesToVoltageForDisplay(List<double> channelDecimalValues) {
    ...
    List<double> voltageDataPoints =
        channelDecimalValues.map((decimalValue) => (decimalValue * referenceVoltage) / maxDecimalValue).toList();
